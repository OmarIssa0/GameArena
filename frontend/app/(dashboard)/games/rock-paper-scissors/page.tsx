  ...
  return (
    <GameLayoutWrapper gameType={GamesKindEnum.RockPaperScissors}>
      <GCard padding={SizeEnum.md} rounded={SizeEnum.lg}>
        ...
        <GList items={CHOICE_ITEMS} keyExtractor={(item) => item.id} noPagination listClassName="grid grid-cols-3 gap-4 mb-6">
          {({ id, labelKey, emoji }) => (
            <GButton
              ...
              variant={myChoice === id ? AccentColorEnum.Primary : isMyTurn && !isOver ? AccentColorEnum.Secondary : AccentColorEnum.Muted}>
