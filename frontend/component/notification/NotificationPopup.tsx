    ...
    <div className="fixed top-4 start-1/2 -translate-x-1/2 z-[var(--z-popover)] animate-in">
      <button
        ...
        <div className="p-1.5 bg-primary-muted rounded-full shrink-0">
          <GIcon icon={Bell} size="sm" color="primary" />
        </div>
        ...
        <GButton variant="ghost" size="icon" onClick={handleDismiss} className="shrink-0 min-w-[32px] min-h-[32px]" aria-label="Dismiss">
          <GIcon icon={X} size="sm" color="muted" />
        </GButton>
      </button>
    </div>
  );
